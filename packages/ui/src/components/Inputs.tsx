    ...
    <div>
      <div className="relative group">
        <input
          ...
          placeholder=" "
          className="peer transition-all duration-300 delay-200 bg-neutral-100 w-full rounded-[5rem] p-8 text-[1.5rem] leading-[20px] placeholder:text-neutral-600 text-deep-200 outline-none border border-transparent focus:border-primary-500 disabled:text-neutral-700"
        />
        <label
          htmlFor="password"
        ...
        <div className="px-8 py-4 space-y-2">
          <div className="flex items-center gap-3">
            {passwordChecks.minLength ? (
              ...
              <div className="w-[20px] h-[20px] rounded-full border-2 border-neutral-400" />
            )}
            <span
