...
export function Input({ children, className, error, ...props }: InputProps) {
    return (
        <div className={cn("relative group", className)}>
            <input {...props} placeholder=' ' className={"peer transition-all duration-300 delay-200 bg-neutral-100 w-full rounded-[5rem] p-8 text-[1.5rem] leading-[20px] placeholder:text-neutral-600 text-deep-200 outline-none border border-transparent focus:border-primary-500"} />
