    ...
    return (
        ...
        <DialogContent className={'w-[360px] lg:w-[520px] '}>
            ...
            <div className='flex flex-col items-center justify-center gap-[40px]'>
                ...
                <div className={'flex flex-col w-auto justify-center items-center gap-[15px]'}>
                    <span className='font-medium text-[2.6rem] leading-12 text-black'>{t('title')}</span>
                    <p
                        className={
            ...
            <DialogFooter className='pt-8'>
                <DialogClose className='w-full'>
                    <span className='bg-primary-50 border-primary-500 hover:border-primary-200  text-primary-500 px-[3rem] py-[15px] border-2 rounded-[100px] text-center font-medium text-[1.5rem] h-auto leading-[20px] cursor-pointer transition-all duration-400 flex items-center justify-center'>{t('cancel')}</span>
                </DialogClose>
                <LinkPrimary className='w-full' href='/auth/login'>{t('proceed')}</LinkPrimary>
            </DialogFooter>
        </DialogContent>
        // </Dialog>
    )
