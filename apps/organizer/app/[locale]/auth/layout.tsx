...
import Logo from "@workspace/ui/assets/images/logo-horizontal-white.svg"
import Image from 'next/image'
import { getTranslations } from 'next-intl/server'
import ticket from "@workspace/ui/assets/images/ticket-auth-bg.svg"
    ...
    return (
        <section className='lg:p-8 lg:bg-primary-500 h-dvh overflow-hidden grid lg:grid-cols-2 gap-8'>
            <div className='pt-12 pl-12 hidden lg:flex flex-col overflow-y-scroll no-scrollbar bg'>
                <Image src={Logo} alt='Ticket Waze Logo' width={140} height={40} className='mb-[50px]' />
                <h1 className='mb-8 font-primary font-bold text-[4.5rem] leading-[6.2rem] text-white max-w-[600px]'>{t('title')}</h1>
