...
import { Currency } from "@workspace/typescript-config";
...
export default function NewOrganisationPage() {
  ...
  } = useForm<TCreateOrganisationSchema>({
    ...
    >
              ...
              <div className="">
                ...
                <div className="flex items-center justify-between">
                  ...
                  {ticketClassDescriptionWordCount > 0 && (
                    <span
                      className={`text-[1.2rem] self-end px-8 py-2 ${ticketClassDescriptionWordCount < 150 ? "text-failure" : "text-success"}`}
                    >
                      {ticketClassDescriptionWordCount} / 350
                    </span>
                  )}
                </div>
              </div>
      ...
      <div className="flex flex-col gap-6 w-full">
        <ButtonPrimary
          ...
          type={"submit"}
          className={
            "w-full disabled:opacity-50 disabled:cursor-not-allowed lg:hidden "
          }
        >
          {isSubmitting ? <LoadingCircleSmall /> : t("submit")}
        </ButtonPrimary>
