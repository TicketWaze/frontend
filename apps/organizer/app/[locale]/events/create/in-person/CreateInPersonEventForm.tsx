...
export default function CreateInPersonEventForm({
  ...
  const [ticketClassDescriptionWordCount, setTicketClassDescriptionWordCount] =
    useState(0);
  const handleTicketClassWordCount = useCallback(
    (e: React.ChangeEvent<HTMLTextAreaElement>) => {
  ...
  return (
    <div className="relative flex flex-col gap-8 overflow-hidden ">
      {/* Navigation */}
      <div className="absolute bottom-4 z-[99999] w-full hidden lg:block">
        <ButtonPrimary
          onClick={next}
      ...
      {currentStep === 0 ? (
        <BackButton text={t("back")}>
          <div className={"flex justify-between"}>
            <div className={"hidden lg:flex items-center gap-4"}>
              <span
                className={
                  "text-primary-500 font-medium text-[1.5rem] leading-[3rem] "
                }
              >
                {t("basic")}
              </span>
              <div
                className={"w-[161px] h-[5px] rounded-[100px] bg-neutral-100"}
              ></div>
              <span
                className={
                  "text-neutral-500 font-medium text-[1.5rem] leading-[3rem] "
                }
              >
                {t("date_time")}
              </span>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className={"hidden lg:flex items-center gap-4"}>
            ...
            <div
              className={"w-[161px] h-[5px] rounded-[100px] bg-primary-500"}
            ></div>
            <span
              className={
                "text-primary-500 font-medium text-[1.5rem] leading-[3rem] "
        ...
        <DialogContent onCloseAutoFocus={(e) => e.preventDefault()}>
          ...
          <DialogFooter>
            <DialogClose asChild onClick={cropImage}>
              <span className="bg-primary-500 disabled:bg-primary-500/50 hover:bg-primary-500/80 hover:border-primary-600 px-[3rem] py-[15px] border-2 border-transparent rounded-[100px] text-center text-white font-medium text-[1.5rem] h-auto leading-[20px] cursor-pointer transition-all duration-400 flex items-center justify-center w-full">
                {t("resize")}
              </span>
            </DialogClose>
          </DialogFooter>
        ...
        {currentStep === 0 && (
          ...
          >
            ...
            >
              <span
                className={
                  "font-semibold text-[16px] leading-[22px] text-deep-100"
                }
              >
                {t("event_details")}
              </span>
              ...
              <div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  {wordCount > 0 && (
                    <span
                      className={`text-[1.2rem] px-8 py-2 ${wordCount < 150 ? "text-failure" : "text-success"}`}
                    >
                      {wordCount} / 350
                    </span>
                  )}
              ...
              {imagePreview ? (
                <div className={"relative w-full h-[300px]"}>
                  ...
                  <input
                    ...
                    className={
                      "absolute top-0 left-0 w-full h-full z-50 opacity-0 cursor-pointer"
                    }
                  />
                </div>
              ) : (
                ...
                >
                  <div className={"flex flex-col items-center gap-4 "}>
                    ...
                    <p
                      className={
                        "text-[1.5rem] leading-[20px] text-neutral-500 "
                      }
                    >
                      {t("thumbnail_text")}{" "}
              ...
              return (
                ...
                >
                  <div className={"flex items-center justify-between"}>
                    ...
                    {index > 0 && (
                      <Trash
                        ...
                        onClick={() => {
                          const updated = eventDays.filter(
                            (_, i) => i !== index
                          );
                  ...
                  {/* <div>
                    ...
                    <span
                      className={
                        "text-[1.2rem] lg:block hidden px-8 py-2 text-failure"
                      }
                    >
                      {errors.eventDays?.[index]?.startTime?.message}
                    </span>
                  ...
                  >
                    ...
                    <div className="">
                      <textarea
                        ...
                        {...register(
                          `ticketTypes.${index}.ticketTypeDescription`
                        )}
                    ...
                    <div className={"flex flex-col lg:flex-row gap-4"}>
                      ...
                      <div className="flex-1">
                        <input
                          ...
                          {...register(
                            `ticketTypes.${index}.ticketTypeQuantity`
                          )}
                        />
                        <span
                          className={
