    ...
    return (
        <DialogContent className={'w-[360px] lg:w-[520px] '}>
            ...
            <DialogFooter>
                ...
                }} className={'border-failure text-failure bg-[#FCE5EA] px-[3rem] py-[15px] border-2 rounded-[100px] text-center  font-medium text-[1.5rem] h-auto leading-[20px] cursor-pointer transition-all duration-400 flex items-center justify-center w-full mt-12'}>{isLoading ? <LoadingCircleSmall /> : t('confirm')}</span>
