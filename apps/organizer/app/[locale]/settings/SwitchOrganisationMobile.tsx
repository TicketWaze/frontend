        ...
        <DialogTrigger className='w-full'>
          ...
          >
            <div className={'flex items-center gap-[15px]'}>
              <ArrowSwapHorizontal size="25" className=' transition-all duration-500 stroke-neutral-900 fill-neutral-900 group-hover:stroke-primary-500 group-hover:fill-primary-500' variant="Bulk" />
              <span
                className={
